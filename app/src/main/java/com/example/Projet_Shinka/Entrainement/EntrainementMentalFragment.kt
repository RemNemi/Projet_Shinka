...
class EntrainementMentalFragment : Fragment() {
    // Crée la vue du fragment, affiche le nom de l'entraînement
    @SuppressLint("MissingInflatedId")
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        val view = inflater.inflate(R.layout.fragment_entrainement_mental, container, false)
        ...
        // Personnalisez l'affichage pour le type d'entraînement mental ici
        return view
    }
}
